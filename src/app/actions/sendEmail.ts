...
export async function sendHiredEmail({ to, candidateName, jobTitle }: SendEmailParams) {
    ...
    try {
        ...
        const signupLink = process.env.NEXT_PUBLIC_SITE_URL ? `${process.env.NEXT_PUBLIC_SITE_URL}/signup` : `https://react-project-4xw1ktv15-amit-mondals-projects-0d224d3d.vercel.app/signup`;
